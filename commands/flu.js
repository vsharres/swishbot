        ...
        .then(members=>{
            members.forEach(member => {              
                ...
                if(!roles)
                {
                    member.createDM()
                    .then(channel=> {
                        channel.send(`Hello Swisher! \nAs a surprise thank you gift to the hosts of Swish and Flick on their anniversary, we thought it would be fun to all leave messages on what they mean to us! If you’d like to participate, click the link below.\nhttps://docs.google.com/forms/d/1MQAA7uw2wV_pUPtF6OUy9NiCz0vJd-LkCACT497ygK4/edit?usp=sharing`)
