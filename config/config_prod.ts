...
export const keys: Keys = {
	...
	slytherin_points_multiplier: process.env.SLYTHERIN_MULT ? parseFloat(process.env.SLYTHERIN_MULT) : 1,
	ravenclaw_points_multiplier: process.env.RAVENCLAW_MULT ? parseFloat(process.env.RAVENCLAW_MULT) : 1,
	gryffindor_points_multiplier: process.env.GRYFFINDOR_MULT ? parseFloat(process.env.GRYFFINDOR_MULT) : 1,
	hufflepuff_points_multiplier: process.env.HUFFLEPUFF_MULT ? parseFloat(process.env.HUFFLEPUFF_MULT) : 1,
	points_likes: 10,
	points_votes: 10,
	number_reactions: 7,
