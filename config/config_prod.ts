...
export const keys: Keys = {
	...
	role_hippogriff: process.env.ROLE_HIPPOGRIFF ? process.env.ROLE_HIPPOGRIFF : '',
	...
	role_X: process.env.ROLE_X ? process.env.ROLE_X : '',
	role_XX: process.env.ROLE_XX ? process.env.ROLE_XX : '',
