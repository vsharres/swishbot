...
var Points = /** @class */ (function (_super) {
    ...
    function Points() {
        return _super.call(this, "points", '', 10, '') || this;
    }
    Points.prototype.execute = function (message, arg, logger) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                Stat_1.default.findById(configs_1.Configs.stats_id).then(function (stat) {
                    ...
                    return print_points_1.printPoints(message, points, logger);
                })
