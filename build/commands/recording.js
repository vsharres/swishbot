...
var Recording = /** @class */ (function (_super) {
    ...
    function Recording() {
        return _super.call(this, "recording", 'Start the recording, prompting the chat for volunteers to be the head pupil', 30, '<date> <time>', true, true) || this;
    }
    Recording.prototype.execute = function (message, args, logger) {
        return __awaiter(this, void 0, void 0, function () {
            var date_string, zoned;
            return __generator(this, function (_a) {
                date_string = moment_timezone_1.default.tz(args.join(' '), "DD MMM YYYY hh:mm aa", 'America/New_York');
                zoned = date_string.format();
