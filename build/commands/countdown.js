...
var Countdown = /** @class */ (function (_super) {
    ...
    function Countdown() {
        return _super.call(this, "countdown", 'Counts down until the next recording', 5, '') || this;
    }
    Countdown.prototype.execute = function (message, args, logger) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                Stat_1.default.findById(configs_1.Configs.stats_id).then(function (stat) {
                    ...
                    var time_to_recording = moment_timezone_1.default(stat.recording_date);
                    var time_now = moment_timezone_1.default(Date.now());
                    //for the case where the recording already happened
                    if (time_to_recording.diff(time_now, 'hours') < 0) {
                        var member_1 = message.member;
                        if (member_1) {
                            return member_1.createDM()
                    ...
                    //lolz
                    if (message.author.id === configs_1.Configs.fletcher_id) {
                        time_to_recording.add(2000 * 60 * 60);
                    }
                    var member = message.member;
                    var time = time_now.to(time_to_recording);
                    if (member) {
                        member.createDM()
                            .then(function (channel) {
